    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f4f3f2] to-white">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-12 sm:py-16">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button asChild className="h-11 rounded-full bg-primary px-6 text-white hover:bg-primary/90">
        ...
        {/* Footer CTA */}
        <div className="mt-10 rounded-3xl border border-black/10 bg-primary p-8 text-center text-white">
