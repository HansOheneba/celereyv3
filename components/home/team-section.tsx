  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <p className="text-sm text-muted-foreground mb-4 uppercase tracking-wide">Expert Guidance</p>
        <h2 className="text-5xl font-light leading-tight mb-8">
          Meet the people behind the guidance
        </h2>
        <p className="text-muted-foreground text-lg mb-12 max-w-2xl">
          Each brings years of experience and a genuine commitment to understanding your situation.
        </p>
          ...
          {advisors.map((advisor, idx) => (
            <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">{advisor.bio}</p>
